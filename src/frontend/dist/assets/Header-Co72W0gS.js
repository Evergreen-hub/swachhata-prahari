import { o, j as jsxRuntimeExports, L as Link, r as reactExports, s as shimExports, b as openDB, c as useQueryClient, a as useNavigate } from "./index-6efX3_t7.js";
import { a as CONTACT_PHONE, c as CONTACT_EMAIL, S as SITE_LOCATION } from "./index-DSavPC3H.js";
import { c as createLucideIcon, b as cn, u as useComposedRefs$1, d as composeRefs$1, e as useActor, f as createActor, B as Button } from "./button-BHNwtKCm.js";
import { e as useCallbackRef, f as useLayoutEffect2, a as useId, P as Primitive$1, c as composeEventHandlers, d as createContextScope$1, u as useControllableState, b as Presence, g as Portal$1, h as hideOthers, i as dispatchDiscreteCustomEvent, j as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, k as createSlot } from "./Combination-DFs1XHPO.js";
import { P as Primitive } from "./index-DdfDEI4I.js";
import { c as createCollection, u as useDirection, R as Root2$1, A as Anchor, a as createPopperScope, C as Content, b as Arrow } from "./index-DXnvnaFp.js";
import { a as useMutation, b as useLocation, L as LogOut, X, M as Menu$1, u as ue } from "./index-g2n4Sv33.js";
import { L as LoaderCircle } from "./loader-circle-CSGiWZFc.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion } from "./proxy-BkMauGKN.js";
/**
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: "Awaaz Safai Ki — Citizens reporting cleanliness issues in Bihar for a cleaner tomorrow." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🌿 Swachh Bharat Mission" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-3 text-sm uppercase tracking-wide", children: "Quick Links" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-3 text-sm uppercase tracking-wide", children: "Legal" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: POLICY_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
            className: "text-muted-foreground hover:text-primary text-sm transition-colors duration-200",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-3 text-sm uppercase tracking-wide", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-3.5 h-3.5 text-primary flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-3.5 h-3.5 text-primary flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: SITE_LOCATION })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              className: "text-muted-foreground hover:text-primary transition-colors",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { className: "w-4 h-4" })
            }
          )
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border mt-8 pt-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "© ",
        year,
        " Swachhata Prahari. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Built by",
        " ",
...
async function signInWithGoogle() {
  ...
  try {
    ...
    if (firebaseErr.code === "auth/popup-blocked" || firebaseErr.code === "auth/popup-closed-by-user" || firebaseErr.code === "auth/cancelled-popup-request") {
      await signInWithRedirect(auth, googleProvider);
      throw new Error("REDIRECT_INITIATED");
    }
    throw err;
...
function useAuth() {
  ...
  reactExports.useEffect(() => {
    getRedirectResult(auth).then(async (result) => {
      if ((result == null ? void 0 : result.user) && actor) {
      ...
      const e = err;
      if ((e == null ? void 0 : e.code) !== "auth/no-auth-event") {
  ...
  reactExports.useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, (user2) => {
      setFirebaseUser(user2);
      setAuthLoading(false);
      if (user2) {
        const u = firebaseUserToUser(user2);
        queryClient.setQueryData(["authUser"], u);
      } else {
  ...
  const signInMutation = useMutation({
    mutationFn: async () => {
      ...
      try {
        ...
        const user2 = firebaseUserToUser(fbUser);
        if (actor) {
          await actor.registerOrUpdateUser({
            id: user2.id,
            name: user2.name,
            ...
            createdAt: BigInt(user2.createdAt)
          });
        }
        return user2;
      } catch (err) {
        const e = err;
        if ((e == null ? void 0 : e.message) === "REDIRECT_INITIATED") return null;
        const errorMessages = {
        ...
        const msg = (e == null ? void 0 : e.code) && errorMessages[e.code] || (e == null ? void 0 : e.message) || "Sign-in failed. Please try again.";
        setSignInError(msg);
        throw new Error(msg);
      }
    },
    onSuccess: (user2) => {
      if (user2) queryClient.setQueryData(["authUser"], user2);
    }
  });
  ...
  const user = firebaseUser ? firebaseUserToUser(firebaseUser) : cachedUser ?? null;
  return {
    user,
...
function Header() {
  ...
  const [brandTextGreen, setBrandTextGreen] = reactExports.useState(false);
  ...
  async function handleSignIn() {
    ...
    try {
      ...
      const e = err;
      if ((e == null ? void 0 : e.message) && e.message !== "REDIRECT_INITIATED") {
        ue.error(e.message || "Sign-in failed. Please try again.");
      }
    } finally {
      setSigningIn(false);
    }
  }
  const isActive = (path) => path === "/" ? location2.pathname === "/" : location2.pathname.startsWith(path);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-[#008000] text-white shadow-md sticky top-0 z-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 h-16 flex items-center justify-between", children: [
          ...
          children: [
            NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                ...
                className: `px-3 py-1.5 rounded-md text-sm font-medium transition-colors duration-200 ${isActive(link.to) ? "bg-[#FF9933] text-white font-semibold" : "text-white/90 hover:bg-white/10 hover:text-white"}`,
                children: link.label
              },
              link.to
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/donate", "data-ocid": "header.nav_donate", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 px-3 py-1.5 rounded-md text-sm font-semibold bg-[#FF9933] text-white hover:bg-[#FF9933]/90 transition-colors duration-200 inline-block", children: "💛 Donate" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/report", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
                className: "ml-2 bg-white text-primary hover:bg-white/90 border-0 font-semibold",
                "data-ocid": "header.report_cta_button",
                children: "+ रिपोर्ट करें"
              }
            ) }),
            isAuthenticated && user ? /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { open: profileOpen, onOpenChange: setProfileOpen, children: [
                ...
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "h-7 w-7", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarImage, { src: user.photoUrl, alt: user.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-secondary text-white text-xs", children: user.name.charAt(0).toUpperCase() })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-white hidden lg:inline max-w-[100px] truncate", children: user.name })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-52", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 border-b", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: user.name }),
              ...
              Button,
              {
                ...
                children: [
                  signingIn ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "svg",
                    {
                      className: "w-4 h-4",
                      viewBox: "0 0 24 24",
                      ...
                      role: "img",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Sign in with Google" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: menuOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-6 h-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu$1, { className: "w-6 h-6" })
        }
      )
    ] }),
            ...
            children: [
              NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  className: `px-3 py-2.5 rounded-md text-sm font-medium transition-colors ${isActive(link.to) ? "bg-[#FF9933] text-white font-semibold" : "text-white/90 hover:bg-white/10"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: link.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/60 text-xs ml-2", children: link.labelHi })
                  ]
                },
                link.to
              )),
              ...
              isAuthenticated && user ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 pt-2 border-t border-white/20", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-3 py-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-white truncate", children: user.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/60 truncate", children: user.email })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
